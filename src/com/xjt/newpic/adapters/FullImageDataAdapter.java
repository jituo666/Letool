...
public class FullImageDataAdapter implements FullImageFragment.Model {
    ...
    private void fireDataChange() {
        ...
        MediaPath oldPaths[] = new MediaPath[N];
    ...
    private void updateScreenNail(MediaPath path, Future<ScreenNail> future) {
    ...
    private void updateFullImage(MediaPath path, Future<BitmapRegionDecoder> future) {
        ImageEntry entry = mImageCache.get(path);
    ...
    private class ReloadTask extends Thread {
        ...
        private int findIndexOfPathInCache(UpdateInfo info, MediaPath path) {
            ArrayList<MediaItem> items = info.items;
