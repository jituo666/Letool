...
import com.xjt.newpic.animations.CaptureAnim;
import com.xjt.newpic.utils.LetoolUtils;
import com.xjt.newpic.utils.RangeArray;
import com.xjt.newpic.utils.RangeIntArray;
import com.xjt.newpic.utils.Utils;
import com.xjt.newpic.views.EdgeView;
import com.xjt.newpic.views.FullImageView;
import com.xjt.newpic.views.FullImageView.Size;
import com.xjt.newpic.views.utils.FlingScroller;
...
public class FullImageLayout {
    ...
    private static final int HORIZONTAL_SLACK = LetoolUtils.dpToPixel(12);
        ...
        private boolean interpolateLinear(float progress) {
            ...
            if (progress >= 1) {
                ...
                if (mAnimationKind == ANIM_KIND_CAPTURE) {
                    progress = CaptureAnim.calculateSlide(progress);
                }
    ...
    private class Box extends Animatable {
        ...
        private boolean interpolateLinear(float progress) {
            if (progress >= 1) {
                ...
                if (mAnimationKind == ANIM_KIND_CAPTURE) {
                    float f = CaptureAnim.calculateScale(progress);
                    mCurrentScale *= f;
                    return false;
                } else {
