...
//            Log.i("--", "contentWidth:" + contentWidth + " contentHeight:" + contentHeight + " mWidth:" + mWidth
//                    + "mHeight:" + mHeight + " mTextureWidth:" + mTextureWidth);
...
//                         + "tile.mWidth:" + tile.mWidth + " tile.mHeight:" + tile.mHeight);
    ...
    // check all tiles are uploaded to gpu memory, if not add it to the request queue:mTextures
    ...
    public void draw(GLESCanvas canvas, RectF source, RectF target) {
        RectF src = mSrcRect;
        RectF dest = mDestRect;
