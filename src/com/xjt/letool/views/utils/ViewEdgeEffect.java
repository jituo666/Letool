...
// (2) Use "GLESCanvas" instead of "Canvas" for draw()'s parameter.
...
//     corresponding GLESCanvas calls.
...
public class ViewEdgeEffect {
     ...
     *         animation
     */
    public boolean draw(GLESCanvas canvas) {
        update();
    ...
    private static class Drawable extends ResourceTexture {
        ...
        public void draw(GLESCanvas canvas) {
