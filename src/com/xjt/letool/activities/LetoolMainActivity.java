...
public class LetoolMainActivity extends LocalMediaActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        AnalyticsConfig.setChannel(StatConstants.UMENG_CHANNEL_ALI); // "LETOOL0000001005";//阿里
        ...
        AnalyticsConfig.setChannel(StatConstants.UMENG_CHANNEL_SANXING); // "LETOOL0000001017";//三星
        AnalyticsConfig.setChannel(StatConstants.UMENG_CHANNEL_LIANXIANG); // "LETOOL0000001018";//联想
