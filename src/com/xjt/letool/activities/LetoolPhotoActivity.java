...
public class LetoolPhotoActivity extends LetoolBaseActivity {

    private static final String TAG = LetoolPhotoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.putBoolean(DataManager.KEY_IS_CAMERA, false);
