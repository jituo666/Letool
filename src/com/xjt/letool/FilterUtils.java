...
public class FilterUtils {
    ...
    public static void setupMenuItems(LetoolActionBar actionBar, Path path, boolean inAlbum) {
    ...
    private static void setMenuItemApplied(LetoolActionBar model, int id, boolean applied, boolean updateTitle) {
        model.setClusterItemEnabled(id, !applied);
    }

    private static void setMenuItemAppliedEnabled(LetoolActionBar model, int id, boolean applied, boolean enabled, boolean updateTitle) {
