...
public class BlobCacheManager {
    ...
    // Return null when we cannot instantiate a BlobCache, e.g.:there is no SD card found.This can only be called from data thread.
        ...
        synchronized (sCacheMap) {
            ...
            if (cache == null) {
                ...
                try {
                    ...
                    LLog.e(TAG, "Cannot instantiate cache!", e);
                }
            }
            return cache;
        }
