 ...
 * @Comments:null
 */
public abstract class DataBaseCacheRequest implements Job<Bitmap> {

    private static final String TAG = DataBaseCacheRequest.class.getSimpleName();
    ...
    private DataBaseCache mLoader;

    public DataBaseCacheRequest(DataBaseCache loader, int type, int index, String path, long dateTaken, int targetSize) {
        mType = type;
