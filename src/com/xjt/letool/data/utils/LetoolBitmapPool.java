...
import com.xjt.letool.data.utils.SparseArrayBitmapPool.Node;
...
public class LetoolBitmapPool {
    ...
    private static final int CAPACITY_BYTES = 20 * 1024 * 1024;//20971520(20M);
    ...
    /**
     * @return Approximate total size in bytes of the bitmaps stored in the
     *         pool.
     */
    public int getSize() {
    ...
    /**
     * @return Bitmap from the pool with the desired height/width or null if
     *         none available.
     */
