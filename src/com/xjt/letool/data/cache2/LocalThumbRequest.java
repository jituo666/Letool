 ...
 * @Comments:null
 */
public class LocalThumbRequest extends ThumbCacheRequest {

    private static final String TAG = LocalThumbRequest.class.getSimpleName();

    public LocalThumbRequest(ThumbCacheLoader loader, int type, int index,  long dateTaken, String localFilePath) {
