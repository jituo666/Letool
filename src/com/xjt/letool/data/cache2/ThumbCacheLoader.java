 ...
 * @Comments:null
 */
public class ThumbCacheLoader {

    private static final String TAG = ThumbCacheLoader.class.getSimpleName();
    ...
    public ThumbCacheLoader(Context app) {
        mApp = app;
    ...
    public ThumbCacheLoader(Context app, long bucketId) {
        mApp = app;
        mBucketId = bucketId;
