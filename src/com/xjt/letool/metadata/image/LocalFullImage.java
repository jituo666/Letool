...
public class LocalFullImage extends LocalMediaItem {

    private static final String TAG = LocalFullImage.class.getSimpleName();
    ...
    public LocalFullImage(MediaPath path, LetoolApp application, Cursor cursor) {
        super(path, nextVersionNumber());
        mApplication = application;
        loadFromCursor(cursor);
    }

    public LocalFullImage(MediaPath path, LetoolApp application, long id) {
        super(path, nextVersionNumber());
        mApplication = application;
