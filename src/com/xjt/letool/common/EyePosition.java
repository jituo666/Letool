...
public class EyePosition {
    ...
    public EyePosition(Context context, EyePositionListener listener) {
        mContext = context;
        mListener = listener;
        mUserDistance = LetoolUtils.meterToPixel(USER_DISTANCE_METER);
        ...
        // The 3D effect where the photo albums fan out in 3D based on angle of device tilt is currently disabled.
/*
